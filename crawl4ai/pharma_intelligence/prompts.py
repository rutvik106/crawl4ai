...
# ── Layer 2: Multi-label Classification ───────────────────────────────────
...
# ── Layer 3: AI-Assisted Exclusion ────────────────────────────────────────
# Used only when rule-based filters are inconclusive
EXCLUSION_PROMPT = """\
...
# ── Layer 5: Leadership Summarization ─────────────────────────────────────
...
- Use precise, active voice (no passive constructions if avoidable)
